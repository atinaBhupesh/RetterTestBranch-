...
public class J_information {
	...
	//@FindBy(
		...
		public void createMonitorInfoFuture(String date, String time, WebDriver driver) throws Throwable 
		{
			...
			enterInfoTitle.click();
			Thread.sleep(2000);
			act.sendKeys("Adding monitor information - future -"+time+" "+date).perform();
			Thread.sleep(2000);
			location.click();
			act.sendKeys("nagpur").perform();
			Thread.sleep(2000);
			act.sendKeys(Keys.TAB).perform();
			Thread.sleep(2000);
			act.sendKeys("Adding monitor information - future - checking-"+time+" "+date).perform();
			Thread.sleep(2000);
			act.sendKeys(Keys.PAGE_DOWN).perform();
			Thread.sleep(2000);
			modeMonitorInfo.click();
		...
		public void createMonitorInfoAboutToComplate(String date, String time, WebDriver driver) throws Throwable 
		{
			...
			enterInfoTitle.click();
			Thread.sleep(2000);
			act.sendKeys("Adding monitor information - going to end-"+time+" "+date).perform();
			Thread.sleep(2000);
			location.click();
			act.sendKeys("nagpur").perform();
			Thread.sleep(2000);
			act.sendKeys(Keys.TAB).perform();
			Thread.sleep(2000);
			act.sendKeys("Adding monitor information -going to end - checking-"+time+" "+date).perform();
			Thread.sleep(2000);
			act.sendKeys(Keys.PAGE_DOWN).perform();
			Thread.sleep(2000);
			modeMonitorInfo.click();
