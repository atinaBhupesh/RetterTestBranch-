...
public class Practice extends B_baseClass{
		...
		{
			Reporter.log("starting the process of deleting manual alarmmmmmmmmmmmm.-"+date, true );
			MA.deleteManaulAlarmPractice( driver);
